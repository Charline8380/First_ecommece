			...
			<table style="width: 100%; text-align: center">
				...
				<c:forEach items="${Panier.mapDesProduitsQte}" var="type">
					<tr>
						...
						<!-- <a	href="BoutonAjouterPanierServlet?id=${type.key.getIdProduit()}">--><img src="img/ajoutQtePan.png" width="25px" alt="img" /><!-- </a>-->
						<!-- <a href="BoutonDiminuerPanierServlet?id=${type.key.getIdProduit()}">--><img src="img/dimQtePan.png" width="25px" alt="img" /><!-- </a>-->
						</td>
						<td>${type.value.getPrixParProduit()}</td>
						<td>
							<div style="float: right">
								<!--<a href="BoutonSupprimerDuPanierServlet?id=${type.key.getIdProduit()}">--><img src="img/suppDuPan.png" width="25px" alt="img" /><!--</a>-->
							</div>
